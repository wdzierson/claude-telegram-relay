      ...
      if (mcpCategories.size > 0) {
        ...
        if (mcpCategories.has("google")) {
          ...
          lines.push(
            ...
            "  1. Create a new presentation with the appropriate google__slides tool",
            "  2. Add slides with content (title, body text, layout)",
            "  3. If images/files are needed, generate them first — MCP tools auto-upload and include a public [URL: ...] in their output",
            "  4. Use the public URL with the Google tool to insert the image/file",
            "  5. Share the presentation URL with the user in your final response",
            "",
            "IMPORTANT: Google APIs require publicly accessible URLs for images and files.",
            "MCP tools include a [URL: ...] in their output — use that URL directly.",
          );
        }
        ...
        if (mcpCategories.has("nanobanana")) {
          lines.push(
            ...
            "The tool output includes both a local file path and a public [URL: ...] (auto-uploaded).",
            ...
            "Use the public URL from the tool output when inserting into Google Docs/Slides.",
          );
        }
